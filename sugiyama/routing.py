...
from sugiyama.utils.geometry import intersectR, getangle, sqrt
...
def route_with_splines(e, pts):
    from sugiyama.utils.geometry import setroundcorner
...
def _gen_point(p1, p2, new_distance):
    from sugiyama.utils.geometry import new_point_at_distance
